...
pub struct ImportHumanUserRequest {
    ...
    pub recovery_codes: ::prost::alloc::vec::Vec<import_human_user_request::RecoveryCode>,
}
...
pub mod import_human_user_request {
    ...
    pub struct RecoveryCode {
        #[prost(oneof="recovery_code::CodeType", tags="1, 2")]
        pub code_type: ::core::option::Option<recovery_code::CodeType>,
    }
    /// Nested message and enum types in `RecoveryCode`.
...
pub struct AddProjectRequest {
    ...
    pub admins: ::prost::alloc::vec::Vec<add_project_request::Admin>,
}
/// Nested message and enum types in `AddProjectRequest`.
