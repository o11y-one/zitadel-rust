...
pub mod administrator_search_filter {
    ...
    pub enum Filter {
        ...
        #[prost(message, tag="1")]
        CreationDate(super::super::super::filter::v2::TimestampFilter),
        /// Search for administrator roles by their change date.
        #[prost(message, tag="2")]
        ChangeDate(super::super::super::filter::v2::TimestampFilter),
        /// Search for administrators roles by the IDs of the users who was granted the administrator role.
        #[prost(message, tag="3")]
        InUserIdsFilter(super::super::super::filter::v2::InIDsFilter),
...
pub struct ListAdministratorsRequest {
    ...
    #[prost(enumeration="AdministratorFieldName", tag="2")]
...
include!("zitadel.internal_permission.v2.tonic.rs");
