...
pub struct AddEmailProviderSmtpRequest {
    ...
    #[prost(string, tag="8")]
    pub description: ::prost::alloc::string::String,
    #[prost(oneof="add_email_provider_smtp_request::Auth", tags="9, 10, 11")]
    pub auth: ::core::option::Option<add_email_provider_smtp_request::Auth>,
}
/// Nested message and enum types in `AddEmailProviderSMTPRequest`.
pub mod add_email_provider_smtp_request {
...
pub struct UpdateEmailProviderSmtpRequest {
    ...
    #[prost(string, tag="9")]
    pub id: ::prost::alloc::string::String,
    #[prost(oneof="update_email_provider_smtp_request::Auth", tags="10, 11, 12")]
    pub auth: ::core::option::Option<update_email_provider_smtp_request::Auth>,
}
/// Nested message and enum types in `UpdateEmailProviderSMTPRequest`.
pub mod update_email_provider_smtp_request {
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum Auth {
        #[prost(message, tag="10")]
        None(super::SmtpNoAuth),
...
pub struct TestEmailProviderSmtpRequest {
    ...
    #[prost(string, tag="8")]
    pub id: ::prost::alloc::string::String,
    #[prost(oneof="test_email_provider_smtp_request::Auth", tags="9, 10, 11")]
    pub auth: ::core::option::Option<test_email_provider_smtp_request::Auth>,
}
/// Nested message and enum types in `TestEmailProviderSMTPRequest`.
pub mod test_email_provider_smtp_request {
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum Auth {
        #[prost(message, tag="9")]
        None(super::SmtpNoAuth),
...
pub struct AddSamlProviderRequest {
    ...
    #[prost(enumeration="super::super::idp::v1::SamlSignatureAlgorithm", tag="10")]
...
pub struct UpdateSamlProviderRequest {
    ...
    /// Specify a Signature Algorithm that should be used to sign SAML requests and responses.
    /// Can be used only if the `with_signed_request` option is set to true.
    #[prost(enumeration="super::super::idp::v1::SamlSignatureAlgorithm", tag="11")]
    pub signature_algorithm: i32,
    /// Metadata of the SAML identity provider.
