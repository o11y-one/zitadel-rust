...
pub struct SamlConfig {
    ...
    #[prost(enumeration="SamlSignatureAlgorithm", tag="7")]
...
pub struct LdapAttributes {
    ...
    #[prost(string, tag="14")]
    pub root_ca: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub enum SamlSignatureAlgorithm {
    SamlSignatureUnspecified = 0,
    SamlSignatureRsaSha1 = 1,
    SamlSignatureRsaSha256 = 2,
    SamlSignatureRsaSha512 = 3,
}
impl SamlSignatureAlgorithm {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::SamlSignatureUnspecified => "SAML_SIGNATURE_UNSPECIFIED",
            Self::SamlSignatureRsaSha1 => "SAML_SIGNATURE_RSA_SHA1",
            Self::SamlSignatureRsaSha256 => "SAML_SIGNATURE_RSA_SHA256",
            Self::SamlSignatureRsaSha512 => "SAML_SIGNATURE_RSA_SHA512",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SAML_SIGNATURE_UNSPECIFIED" => Some(Self::SamlSignatureUnspecified),
            "SAML_SIGNATURE_RSA_SHA1" => Some(Self::SamlSignatureRsaSha1),
            "SAML_SIGNATURE_RSA_SHA256" => Some(Self::SamlSignatureRsaSha256),
            "SAML_SIGNATURE_RSA_SHA512" => Some(Self::SamlSignatureRsaSha512),
            _ => None,
        }
    }
}
