...
pub mod web_key_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct WebKeyServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl WebKeyServiceClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> WebKeyServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            WebKeyServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("zitadel.webkey.v2.WebKeyService", "CreateWebKey"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("zitadel.webkey.v2.WebKeyService", "ActivateWebKey"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("zitadel.webkey.v2.WebKeyService", "DeleteWebKey"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("zitadel.webkey.v2.WebKeyService", "ListWebKeys"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
